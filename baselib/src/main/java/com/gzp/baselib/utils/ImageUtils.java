...
import static com.gzp.baselib.utils.FileUtils.createFileByDeleteOldFile;
import static com.gzp.baselib.utils.FileUtils.getFileByPath;
import static com.gzp.baselib.utils.FileUtils.getFileExtension;
import static com.gzp.baselib.utils.IOUtils.is2Bytes;
import static com.gzp.baselib.utils.StringUtils.isSpace;
...
public final class ImageUtils {
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(BaseApplication.instance.getResources(), bitmap);
    }
    ...
    public static Drawable tintDrawable(@DrawableRes int drawableRes, @ColorInt int color) {
        Drawable drawable = ContextCompat.getDrawable(BaseApplication.instance, drawableRes);
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId) {
        Drawable drawable = ContextCompat.getDrawable(BaseApplication.instance, resId);
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId, final int maxWidth, final int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        final Resources resources = BaseApplication.instance.getResources();
        options.inJustDecodeBounds = true;
